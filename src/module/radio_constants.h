...
// register RX_PW_PO
const uint8_t RX_PW_P0_shift = 0;
const uint8_t RX_PW_P0_mask = 0b00111111;

// register RX_PW_P1
const uint8_t RX_PW_P1_shift = 0;
const uint8_t RX_PW_P1_mask = 0b00111111;

// register RX_PW_P2
const uint8_t RX_PW_P2_shift = 0;
const uint8_t RX_PW_P2_mask = 0b00111111;

// register RX_PW_P3
const uint8_t RX_PW_P3_shift = 0;
const uint8_t RX_PW_P3_mask = 0b00111111;

// register RX_PW_P4
const uint8_t RX_PW_P4_shift = 0;
const uint8_t RX_PW_P4_mask = 0b00111111;

// register RX_PW_P5
const uint8_t RX_PW_P5_shift = 0;
const uint8_t RX_PW_P5_mask = 0b00111111;
